...
<html lang="en">
  <head>
    ...
    <title>Form Create Student</title>
  </head>
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="container mt-3">
        <h2 class="border-bottom">Form add Student</h1>
          @if (count($errors) > 0)
        ...
        @endif
        <form class="mt-3" method="POST" action="{{ route('student.store') }}" >
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="school_origin" placeholder="Gayman Elementary" value="{{ old('school_origin') }}">
            </div>
            <div class="mb-3">
                <label for="grade" class="form-label">Grade</label>
                <input type="number" class="form-control" name="grade" placeholder="50" value="{{ old('grade') }}">
            </div>
